...
<div class="col-md-9">
	...
	<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <br>
                    ...
                    <?php echo form_open(site_url('client/project_file/upload/' . $row['project_code']), array(
                    ...
                    <div class="tab-pane" id="profile">
                        ...
                        <?php
                        echo form_open(site_url('client/project_file/dropzone_upload/' . $row['project_code']), array('class' => 'form-horizontal form-groups-bordered validate validate project-file-multiple-add',
                            'enctype' => 'mutipart/form-data'));
                        ?>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="file" 
                                       ...
                                       multiple="multiple" data-label="<i class='glyphicon glyphicon-circle-arrow-up'></i> &nbsp;Seleccionar archivos" 
    ...
    <?php echo form_close(); ?> 
                    ...
                    <div class="tab-pane" id="messages">
                        <?php echo form_open(site_url('client/project_file/dropbox_upload/' . $row['project_code']), array(
...
<script>
    ...
    var post_refresh_url = '<?php echo site_url('client/reload_projectroom_file_list/' . $project_code); ?>';
</script>
