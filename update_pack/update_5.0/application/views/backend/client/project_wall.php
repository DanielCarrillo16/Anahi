...
<div class="col-md-9">
	...
	<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				...
				<?php echo form_open(site_url('client/project_message/add/' . $project_code), array(
					...
					<div class="form-group">
						...
						<label>
							<input type="file" class="form-control file2 inline btn btn-default" name="userfile"
								data-label="<i class='glyphicon glyphicon-circle-arrow-up'></i> Subir archivo" />
						</label>
						</div>
                ...
                <div class="alert alert-default" style="position:relative; padding:15px 15px 20px 15px;">
                    ...
                    <span style="position:absolute; left:14px; bottom:2px; color:#A6A6A6; font-size:9px;">
                    	<a href="<?php echo site_url('client/project_message/download/' . $row2['project_message_id']);?>" 
...
<script>
    ...
    var post_refresh_url    =   '<?php echo site_url('client/reload_projectroom_wall/' . $project_code);?>';
