...
?>
 ...
 <div class="col-md-7">
        ...
        <a href="#" class="btn btn-info pull-right tooltip-primary"
           ...
           onclick="showAjaxModal('<?php echo site_url('modal/popup/project_bug_add/' . $project_code); ?>');">
bugs
                        ...
                        <tr>
                            ...
                            <td style="width: 20%">
                                ...
                                <a class="tooltip-default" style="color:#aaa;" data-toggle="tooltip" 
                                   ...
                                   href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/project_bug_view/' . $row1['project_bug_id']); ?>')">
                                ...
                                <a class="tooltip-default" style="color:#aaa;cursor:pointer;" data-toggle="tooltip"
                                       ...
                                       onclick="showAjaxModal('<?php echo site_url('modal/popup/project_bug_edit/' . $row1['project_bug_id'] . '/' . $project_code); ?>');">
                                ...
                                <a class="tooltip-default" style="color:#aaa;cursor:pointer;" data-toggle="tooltip"
                                       ...
                                       onclick="confirm_modal('<?php echo site_url('admin/project_bug/delete/' . $row1['project_bug_id']); ?>', '<?php echo site_url('admin/reload_projectroom_bug/' . $project_code); ?>');">
