...
<?php echo form_open(site_url('staff/project_note/save' . $row['project_code']), array(
...
<script>
    ...
    var post_refresh_url    =   '<?php echo site_url('staff/reload_projectroom_note/' . $project_code);?>';
</script>
