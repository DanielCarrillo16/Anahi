...
<div class="col-md-7">
    ...
    -webkit-transform: rotate(90deg); /* Chrome, Safari, Opera */ transform: rotate(90deg);">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu" style="text-align:left;">
                                        ...
                                        <li>
                                            <a href="#" onclick="confirm_modal('<?php echo site_url('staff/project_milestone/delete/' . $row2['project_milestone_id']);?>' , '<?php echo site_url('staff/reload_projectroom_payment/' . $row2['project_code']); ?>')">
