    ...
    <div class="panel panel-primary" data-collapsed="0">
        ...
        <div class="panel-body">
            ...
            <p style="font-size: 10px;">
                ...
                <?php
                $total=0;
                $amount = $this->db->get_where('payment',array('project_code'=>$project_code,'type'=>'income'))->result_array();
                foreach ($amount as $row1):
                    $total = $total+$row1['amount'];
                endforeach;
                echo 'Paid Amount:'.$total;
                ?>
                &nbsp;
                <?php
                $total=0;
                $amount = $this->db->get_where('payment',array('project_code'=>$project_code,'type'=>'expense'))->result_array();
                foreach ($amount as $row1):
                    $total = $total+$row1['amount'];
                endforeach;
                echo 'Expense:'.$total;
