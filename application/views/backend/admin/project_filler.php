...
?>
 ...
 <div class="col-md-6">
        ...
        <a href="#" class="btn btn-info pull-right tooltip-primary"
           ...
           onclick="showAjaxModal('<?php echo site_url('modal/popup/project_filler_add/' . $project_code); ?>');">

            <i class="entypo-plus"></i> Agregar Filler
        ...
        <div class="panel panel-primary main_data">
            ...
            <div class="panel-heading">
                ...
                <div class="panel-title">filler</div>
            ...
            <table class="table  table-responsive">
                ...
                <tbody>
                    ...
                    $this->db->order_by('project_filler_id', 'desc');

                    $filler = $this->db->get_where('project_filler', array('project_code' => $project_code))->result_array();

                    foreach ($filler as $row1):
                        ...
                        <tr>
                            ...
                            <td style="width: 20%">
                                ...
                                <a class="tooltip-default" style="color:#aaa;" data-toggle="tooltip"
                                   ...
                                   href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/project_filler_view/' . $row1['project_filler_id']); ?>')">
                                ...
                                <a class="tooltip-default" style="color:#aaa;cursor:pointer;" data-toggle="tooltip"
                                       ...
                                       onclick="showAjaxModal('<?php echo site_url('modal/popup/project_filler_edit/' . $row1['project_filler_id'] . '/' . $project_code); ?>');">
                                ...
                                <a class="tooltip-default" style="color:#aaa;cursor:pointer;" data-toggle="tooltip"
                                       ...
                                       onclick="confirm_modal('<?php echo site_url('admin/project_filler/delete/' . $row1['project_filler_id']); ?>', '<?php echo site_url('admin/reload_projectroom_filler/' . $project_code); ?>');">
