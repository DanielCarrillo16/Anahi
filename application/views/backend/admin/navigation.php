    ...
    <ul id="main-menu" class="">
        ...
        <li class="<?php if ($page_name == 'client' ||
            ...
            <a href="#">
                ...
                <span><?php echo get_phrase('client_contact_info'); ?></span>
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'client' ||
                    ...
                    <!-- <li class="<?php if ($page_name == 'influencer') echo 'active';?>">
                        ...
                        <span><?php echo get_phrase('influencer'); ?></span>
        ...
        <li class="<?php if ($page_name == 'servicios') echo 'active';?>">

            <a href="<?php echo site_url('admin/servicios'); ?>">
