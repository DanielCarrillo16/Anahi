    ...
    <div class="col-md-7">
        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <!-- project edit form -->
                <?php echo form_open(site_url('admin/project/edit/' . $row['project_code']), array('class' => 'form-horizontal form-groups-bordered', 'enctype' => 'multipart/form-data')); ?>
           ...
           <div class="panel-heading">
                ...
                <?php if ($number_of_staffs > 0): ?>
                            <a href="<?php echo site_url('admin/projectroom/edit/' . $project_code); ?>" 
                                    class="btn btn-default tooltip-primary pull-right" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('manage_staff'); ?>">
                                <i class="entypo-pencil"></i>
                            </a>
                <?php endif; ?>
                    </div>
