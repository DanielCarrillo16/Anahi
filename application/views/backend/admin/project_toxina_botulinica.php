...
?>
 ...
 <div class="col-md-6">
        ...
        <a href="#" class="btn btn-info pull-right tooltip-primary"
           ...
           onclick="showAjaxModal('<?php echo site_url('modal/popup/project_toxina_botulinica_add/' . $project_code); ?>');">

            <i class="entypo-plus"></i> Agregar toxina botulinica
        ...
        <div class="panel panel-primary main_data">
            ...
            <div class="panel-heading">
                ...
                <div class="panel-title">Toxina botulinica</div>
            ...
            <table class="table  table-responsive">
                ...
                <tbody>
                    ...
                    $this->db->order_by('project_toxina_botulinica_id', 'desc');

                    $toxina_botulinica = $this->db->get_where('project_toxina_botulinica', array('project_code' => $project_code))->result_array();

                    foreach ($toxina_botulinica as $row1):
                        ...
                        <tr>
                            ...
                            <td><?php echo $row1['id_historial_clinico'];  ?></td>
                            ...
                            <td style="width: 20%">
                                ...
                                <a class="tooltip-default" style="color:#aaa;" data-toggle="tooltip"
                                   ...
                                   href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/project_toxina_botulinica_view/' . $row1['project_toxina_botulinica_id']); ?>')">
                                ...
                                <a class="tooltip-default" style="color:#aaa;cursor:pointer;" data-toggle="tooltip"
                                       ...
                                       onclick="showAjaxModal('<?php echo site_url('modal/popup/project_toxina_botulinica_edit/' . $row1['project_toxina_botulinica_id'] . '/' . $project_code); ?>');">
                                ...
                                <a class="tooltip-default" style="color:#aaa;cursor:pointer;" data-toggle="tooltip"
                                       ...
                                       onclick="confirm_modal('<?php echo site_url('admin/project_toxina_botulinica/delete/' . $row1['project_toxina_botulinica_id']); ?>', '<?php echo site_url('admin/reload_projectroom_toxina_botulinica/' . $project_code); ?>');">
