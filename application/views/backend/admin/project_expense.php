                ...
                <tbody>
                    ...
                    foreach ($payment as $row1):
                        ...
                        <tr>
                            ...
                            <td >
                                <?php echo $this->crud_model->get_currency() . $row1['amount']; ?>
                            </td>
                            ...
                            <td style="width: 20%">
                                <a class="tooltip-default" style="color:#aaa;cursor:pointer;" data-toggle="tooltip"
                                       ...
                                       onclick="showAjaxModal('<?php echo site_url('modal/popup/project_expense_edit/' . $row1['payment_id']); ?>');">
                                        <i class="entypo-pencil"></i>
                                </a>
                                <a class="tooltip-default" style="color:#aaa;cursor:pointer;" data-toggle="tooltip"
                                       data-placement="top" data-original-title="<?php echo get_phrase('delete'); ?>"
                                       onclick="confirm_modal('<?php echo site_url('admin/project_expense/delete/' . $row1['payment_id']); ?>', '<?php echo site_url('admin/reload_projectroom_expense/' . $project_code); ?>');">
