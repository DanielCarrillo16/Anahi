...
?>
 ...
 <div class="col-md-6">
        ...
        <a href="#" class="btn btn-info pull-right tooltip-primary"
           ...
           onclick="showAjaxModal('<?php echo site_url('modal/popup/project_nota_evolucion_add/' . $project_code); ?>');">
        ...
        <div class="panel panel-primary main_data">
            ...
            <table class="table  table-responsive">
                ...
                <tbody>
                    ...
                    $this->db->order_by('project_nota_evolucion_id', 'desc');

                    $nota_evolucion = $this->db->get_where('project_nota_evolucion', array('project_code' => $project_code))->result_array();

                    foreach ($nota_evolucion as $row1):
                        ...
                        <tr>
                            ...
                            <td style="width: 20%">
                                ...
                                <a class="tooltip-default" style="color:#aaa;" data-toggle="tooltip"
                                   ...
                                   href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/project_nota_evolucion_view/' . $row1['project_nota_evolucion_id']); ?>')">
                                ...
                                <a class="tooltip-default" style="color:#aaa;cursor:pointer;" data-toggle="tooltip"
                                       ...
                                       onclick="showAjaxModal('<?php echo site_url('modal/popup/project_nota_evolucion_edit/' . $row1['project_nota_evolucion_id'] . '/' . $project_code); ?>');">
                                ...
                                <a class="tooltip-default" style="color:#aaa;cursor:pointer;" data-toggle="tooltip"
                                       ...
                                       onclick="confirm_modal('<?php echo site_url('admin/project_nota_evolucion/delete/' . $row1['project_nota_evolucion_id']); ?>', '<?php echo site_url('admin/reload_projectroom_nota_evolucion/' . $project_code); ?>');">
