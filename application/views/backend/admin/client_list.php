        ...
        <tbody>
            ...
            foreach ($clients as $row):
                ...
                <tr>
                    ...
                    <td>
                        <?php if(file_exists('uploads/client_image/'.$row['client_id'].'.jpg')): ?>
                            <img src="<?php echo base_url('uploads/client_image/'.$row['client_id'].'.jpg'); ?>" alt="" class="img-circle" width="50" height="50">
                        <?php else: ?>
                    ...
                    <td>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                ...
                                <!-- PROFILE LINK -->
                                <li>
                                    <a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/client_profile/' . $row['client_id']); ?>');">
                                        <i class="entypo-user"></i>
                                ...
                                <!-- DELETION LINK -->
                                <li>
                                    <a href="#" onclick="confirm_modal('<?php echo site_url('admin/client/delete/' . $row['client_id']); ?>', '<?php echo site_url('admin/reload_client_list'); ?>');" >
                                        <i class="entypo-trash"></i>
