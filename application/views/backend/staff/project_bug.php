...
?>
 ...
 <div class="col-md-7">
        ...
        <a href="#" class="btn btn-info pull-right tooltip-primary"
           ...
           onclick="showAjaxModal('<?php echo site_url('modal/pobugsproject_bug_add/' . $project_code); ?>');">
                        ...
                        <tr>
                            ...
                            <td style="width: 20%">
                                ...
                                <a class="tooltip-default" style="color:#aaa;cursor:pointer;" data-toggle="tooltip"
                                       ...
                                       onclick="confirm_modal('<?php echo site_url('staff/project_bug/delete/' . $row1['project_bug_id']); ?>', '<?php echo site_url('staff/reload_projectroom_bug/' . $project_code); ?>');">
