...
class Admin extends CI_Controller
{
    ...
    ///INFLUENCERS///
    function influencer($param1 = '', $param2 = '')
    {
        if ($this->session->userdata('admin_login') != 1) {
            $this->session->set_userdata('last_page', current_url());
            redirect(site_url('login'), 'refresh');
        ...
        if ($param1 == 'create') {
            $influencer = $this->db->get_where('influencer', array(
                'email' => $this->input->post('email')
            ));
            if ($client->num_rows <= 0)
                $this->crud_model->create_influencer();
        }
        if ($param1 == 'edit')
            $this->crud_model->update_influencer($param2);
        if ($param1 == 'delete')
            $this->crud_model->delete_influencer($param2);

        $page_data['page_name']  = 'influencer';
        $page_data['page_title'] = get_phrase('manage_client');
        $this->load->view('backend/index', $page_data);
    }

    // reloads the client list body
    function reload_influencer_list()
    {
        $this->load->view('backend/admin/influencer_list');
    }
    ...
    function projectroom($param1 = '', $param2 = '')
    {
        ...
        // projectroom historia clinica
        else if ($param1 == 'historia_clinica') {
            $page_data['room_page']    = 'project_historia_clinica';
            $page_data['project_code'] = $param2;
        }
 ...
 // projectroom progreso
 else if ($param1 == 'progreso') {
    $page_data['room_page']    = 'project_progreso';
    $page_data['project_code'] = $param2;
}
        // projectroom files
        else if ($param1 == 'file') {
            ...
            $page_data['room_page']    = 'project_lab';
            $page_data['project_code'] = $param2;
        }
    ...
    // projectroom progreso
    function project_progreso($param1 = '', $param2 = '', $param3 = '')
    {
        if ($this->session->userdata('admin_login') != 1) {
            $this->session->set_userdata('last_page', current_url());
            redirect(site_url('login'), 'refresh');
        ...
        if ($param1 == 'upload') {
            $this->crud_model->upload_project_progreso($param2); // param2 = project_code
        } else if ($param1 == 'dropzone_upload') {
            $this->crud_model->dropzone_upload_progreso($param2); // param2 = project_code
        } else if ($param1 == 'dropbox_upload') {
            $this->crud_model->dropbox_upload_progreso($param2); // param2 = project_code
        } else if ($param1 == 'download')
            $this->crud_model->download_project_progreso($param2); // param2 = project_file_id
        else if ($param1 == 'delete')
            $this->crud_model->delete_project_progreso($param2); // param2 = project_file_id
    }

    // reloads the projectroom file list
    function reload_projectroom_progreso_list($project_code = '')
    {
        $page_data['project_code'] = $project_code;
        $this->load->view('backend/admin/project_file_progreso', $page_data);
    }


    //projectroom lab
        function project_lab($param1 = '', $param2 = '', $param3 = '')
        {
            if ($this->session->userdata('admin_login') != 1) {
                $this->session->set_userdata('last_page', current_url());
                redirect(site_url('login'), 'refresh');
            ...
            if ($param1 == 'upload') {
                $this->crud_model->upload_project_lab($param2); // param2 = project_code
            } else if ($param1 == 'dropzone_upload') {
                $this->crud_model->dropzone_upload_lab($param2); // param2 = project_code
            } else if ($param1 == 'dropbox_upload') {
                $this->crud_model->dropbox_upload_lab($param2); // param2 = project_code
            } else if ($param1 == 'download')
                $this->crud_model->download_project_lab($param2); // param2 = project_file_id
            else if ($param1 == 'delete')
                $this->crud_model->delete_project_lab($param2); // param2 = project_file_id
        }
    ...
    function project_bug($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        // projectroom historia clinica
        function project_historia_clinica($param1 = '', $param2 = '', $param3 = '')
        {
            if ($this->session->userdata('admin_login') != 1) {
                $this->session->set_userdata('last_page', current_url());
                redirect(site_url('login'), 'refresh');
            ...
            if ($param1 == 'create') {
                $this->crud_model->create_project_historia_clinica($param2); // param2 = project_code
            } else if ($param1 == 'edit') {
                $this->crud_model->update_project_historia_clinica($param2); // param2 = project_bug_id
            } else if ($param1 == 'delete') {
    ...
    function reload_projectroom_historia_clinica($project_code = '')
    {
        $page_data['project_code'] = $project_code;
        $this->load->view('backend/admin/project_historia_clinica', $page_data);
    }
    ...
    function product($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'edit') {
            $this->crud_model->edit_product($param2);
        }
        if ($param1 == 'delete') {
    ...
    {
        $this->load->view('backend/admin/product_list');
    }


    function servicios($param1 = '', $param2 = '')
    {
        if ($this->session->userdata('admin_login') != 1) {
            $this->session->set_userdata('last_page', current_url());
            redirect(site_url('login'), 'refresh');
        ...
        if ($param1 == 'create') {
            $this->crud_model->create_servicios();
        }
        if ($param1 == 'edit') {
            $this->crud_model->edit_servicios($param2);
        }
        if ($param1 == 'delete') {
            $this->crud_model->delete_servicios($param2);
        }
        $page_data['page_name']  = 'servicios';
        $page_data['page_title'] = get_phrase('servicios');
        $this->load->view('backend/index', $page_data);
    }

    function reload_servicios_list()
    {
        $this->load->view('backend/admin/servicios_list');
    }
