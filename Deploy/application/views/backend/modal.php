	...
	function showAjaxModal(url)
	{
		...
		jQuery('#modal_ajax .modal-body').html('<div style="text-align:center;margin-top:200px;"><img src="'+'<?php echo base_url() ?>'+'/assets/images/preloader.gif" style="height:25px;" /></div>');
        ...
        <div class="modal-dialog" >
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Anahí CRM</h4>
                </div>
