        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-heading">
                <div class="panel-title">
                    <?php echo get_phrase('Descripción_del_proyecto'); ?>
                </div>
            ...
            <div class="panel-body">
                ...
                <?php echo form_open(site_url('admin/project_message/add/' . $project_code), array(
    ...
    <?php echo form_close(); ?>
        ...
        <?php if ($row2['message_file_name'] != ''): ?>
                            <span style="position:absolute; left:14px; bottom:2px; color:#A6A6A6; font-size:9px;">
                                <a href="<?php echo site_url('admin/project_message/download/' . $row2['project_message_id']); ?>" 
...
<script>
                                ...
                                var post_refresh_url = '<?php echo site_url('admin/reload_projectroom_wall/' . $project_code); ?>';
