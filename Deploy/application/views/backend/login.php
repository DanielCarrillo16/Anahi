        ...
        <section class="gray-bg height-100vh d-flex align-items-center page-section-ptb ">
            <div class="container">
                <div class="row no-gutters justify-content-center">
                    <div class="col-lg-4 col-md-6 login-fancy-bg bg-overlay-black-10" style="background: url(<?php echo base_url();?>assets/images/login_bg.jpg);">
                        <div class="login-fancy pos-r">
                            <div class="text-center">
                                <div style="padding: 40px;" class="d-none d-md-block"></div>
                                <img src="<?php echo base_url().'uploads/logo_webb-02-1.png'; ?>" height="40" />
                                <h2 class="text-white mb-20"></h2>
                                <h4 class="text-white mb-20"><?php echo get_phrase('anahí');?></h4>
                            </div>
                        </div>
                    </div>
