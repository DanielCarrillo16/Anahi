		...
		<table class="table   datatable" id="table_export">
			...
			<tbody>
				...
				<tr>
					...
					<td style="max-width: 80px;"><?php echo $row['name'];?></td>
					<td>
		                <?php if(file_exists('uploads/staff_image/'.$row['staff_id'].'.jpg')): ?>
		                    <img src="<?php echo base_url('uploads/staff_image/'.$row['staff_id'].'.jpg'); ?>" alt="" class="img-circle" width="50" height="50">
		                <?php else: ?>
					...
					<td>
		            	<div class="btn-group">
		                  ...
		                  <ul class="dropdown-menu dropdown-default pull-right" role="menu">
		                      ...
		                      <!-- PROFILE LINK -->
		                      <li>
		                          <a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/staff_profile/' . $row['staff_id']);?>');">
		                      ...
		                      <!-- EDITING LINK -->
		                      <li>
		                          <a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/staff_edit/' . $row['staff_id']);?>');">
		                      ...
		                      <!-- DELETION LINK -->
		                      <li>
		                          <a href="#" onclick="confirm_modal('<?php echo site_url('admin/staff/delete/' . $row['staff_id']);?>' , '<?php echo site_url('admin/reload_staff_list');?>');" >
