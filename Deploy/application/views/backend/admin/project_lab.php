...
foreach ($current_project as $row):
            ...
            <div class="panel-body">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="home">
                        ...
                        <?php
                        echo form_open(site_url('admin/project_lab/upload/' . $row['project_code']), array(
                    ...
                    <div class="tab-pane" id="profile">
                        ...
                        <?php
                            echo form_open(site_url('admin/project_lab/dropzone_upload_lab/' . $row['project_code']), array(
                    ...
                    <?php
                        echo form_open(site_url('admin/project_lab/dropbox_upload_lab/' . $row['project_code']), array(
                    ...
                    ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="hidden" name="dropbox_lab_link" value="" id="dropbox_lab_link" />
                                <input type="hidden" name="dropbox_lab_name" value="" id="dropbox_lab_name" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="field-1" class="col-sm-4 control-label"><?php echo get_phrase('short_note'); ?></label>
    ...
    <?php include 'project_lab_list.php'; ?>
    ...
    <script type="text/javascript">
        ...
        options_chooser = {
            ...
            success: function (files) {
                ...
                $("#dropbox_lab_name").attr("value", files[0].name);
                $("#dropbox_lab_link").attr("value", files[0].link);
            },
...
<script>
    ...
    var post_refresh_url = '<?php echo base_url(); ?>index.php?admin/reload_projectroom_lab_list/<?php echo $project_code; ?>';
</script>
