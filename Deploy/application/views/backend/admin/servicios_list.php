          	...
          	<div class="btn-group">
                  ...
                  <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                    ...
                    <li>
                        ...
                        <a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/servicios_view/' . $row['servicios_id']);?>');">
                    ...
                    <li>
                        ...
                        <a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/servicios_edit/' . $row['servicios_id']);?>');">
                    ...
                    <li>
                        ...
                        <a href="#" onclick="confirm_modal('<?php echo site_url('admin/servicios/delete/' . $row['servicios_id']);?>' , '<?php echo site_url('admin/reload_servicios_list');?>');" >
