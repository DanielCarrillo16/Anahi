...
<div class="col-md-6">
    ...
    <a href="#" class="btn btn-info pull-right tooltip-primary"
        onclick="showAjaxModal('<?php echo site_url('modal/popup/project_milestone_add/' . $row['project_code']); ?>');">
                    ...
                    foreach ($milestones as $row2):
                        ...
                        <tr>
                            ...
                            <td><?php echo date("d/m/Y" , $row2['timestamp']);?></td>
														<td><?php echo $this->crud_model->get_currency() . '' . $row2['amount'];?></td>
                            <td>
    ...
    -webkit-transform: rotate(90deg); /* Chrome, Safari, Opera */ transform: rotate(90deg);">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu" style="text-align:left;">
                                        <li>
                                            ...
                                            <a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/project_milestone_view/' . $row2['project_milestone_id']);?>')">
                                                <i class="entypo-doc-text-inv"></i>
                                                View / Print / Email
                                            </a>

                                            <?php if ($row2['status'] != 1):?>
                                            <a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/project_milestone_manual_pay/' . $row2['project_milestone_id']);?>')">
                                                <i class="entypo-credit-card"></i>
                                                <?php echo get_phrase('take_manual_payment'); ?>
                                            </a>

                                            <a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/project_milestone_edit/' . $row2['project_milestone_id']);?>')">
                                        ...
                                        <li>
                                            <a href="#" onclick="confirm_modal('<?php echo site_url('admin/project_milestone/delete/' . $row2['project_milestone_id']);?>' , '<?php echo site_url('admin/reload_projectroom_payment/' . $row2['project_code']); ?>')">
    ...
    <div class="alert alert-default">
        <strong style="color: #818da1;">
            <?php echo get_phrase('total_amount');?> : <?php echo $this->crud_model->get_currency() . $total_amount;?> &nbsp; &nbsp; &nbsp;
            <?php echo get_phrase('paid_amount');?> : <?php echo $this->crud_model->get_currency() . $paid_amount;?> &nbsp; &nbsp; &nbsp;
            <?php echo get_phrase('due');?> : <?php echo $this->crud_model->get_currency() . ($total_amount - $paid_amount);?>
        </strong>
    </div>
