<?php
  $update = $this->db->get_where('servicios', array('servicios_id' => $param2))->result_array();
    ...
    <div class="panel panel-primary" data-collapsed="0">
      <div class="panel-heading">
        <div class="panel-title" >
            ...
            <?php echo get_phrase('edit_servicios'); ?>
        </div>
      </div>
      <div class="panel-body">

        <?php echo form_open(site_url('admin/servicios/edit/'. $param2), array(
        ...
        <div class="form-group">
          <div class="col-sm-offset-4 col-sm-7">
            <button type="submit" class="btn btn-info" id="submit-button"><?php echo get_phrase('add_servicios'); ?></button>
...
<script>
    ...
    var post_refresh_url = '<?php echo site_url('admin/reload_servicios_list'); ?>';
</script>
...
function show_response_expense_add(responseText, statusText, xhr, $form)  {
    ...
    toastr.success("servicios added successfully", "Success");
