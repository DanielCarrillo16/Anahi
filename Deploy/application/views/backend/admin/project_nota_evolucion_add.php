...
<div class="col-md-12">
    ...
    <div class="panel panel-primary" data-collapsed="0">
        ...
        <div class="panel-body">
            ...
            <?php echo form_open(site_url('admin/project_nota_evolucion/create/'.$param2), array('class' => 'form-horizontal form-groups-bordered validate project-nota_evolucion-add', 'enctype' => 'multipart/form-data')); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <textarea class="form-control" name="comentarios_paciente"></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <textarea class="form-control" name="cobservaciones"></textarea>
                </div>
            </div>
    ...
    <select name="assigned_staff" class="select2">
        ...
        ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="date" class="form-control" name="siguiente_cita" data-validate="required" data-message-required="<?php echo get_phrase('value_required'); ?>" value="" autofocus>
                </div>
            </div>
...
var post_refresh_url = '<?php echo site_url('admin/reload_projectroom_nota_evolucion/' . $param2); ?>';
...
var options = {
    ...
    beforeSubmit: validate_project_nota_evolucion_add,

    success: show_response_project_nota_evolucion_add,

    resetForm: true

};

$('.project-nota_evolucion-add').submit(function () {
...
function validate_project_nota_evolucion_add(formData, jqForm, options) {
...

{
    ...
    toastr.error("Please enter a nota_evolucion", "Error");
...
function show_response_project_nota_evolucion_add(responseText, statusText, xhr, $form)  {





toastr.success("Project nota_evolucion added successfully", "Success");
