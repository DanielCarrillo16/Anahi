...
foreach ($current_project as $row):
            ...
            <div class="panel-body">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="home">
                        ...
                        <?php
                        echo form_open(site_url('admin/project_progreso/upload/' . $row['project_code']), array(
                    ...
                    <div class="tab-pane" id="profile">
                        ...
                        <?php
                            echo form_open(site_url('admin/project_progreso/dropzone_upload_progreso/' . $row['project_code']), array(
                                'class' => 'form-horizontal form-groups-bordered validate validate project-file-multiple-add',
                                    'enctype' => 'mutipart/form-data'));
                        ?>
                        <div class="form-group">
                            <label for="field-1" class="col-sm-4 control-label">Buscar archivo</label>
                            <div class="col-sm-6">
                                <input type="file" 
                                       class=" file2  btn btn-primary"
                                       multiple="multiple" data-label="<i class='entypo-up'></i> &nbsp;Buscar archivo" 
                    ...
                    <?php
                        echo form_open(site_url('admin/project_progreso/dropbox_upload_progreso/' . $row['project_code']), array(
                    ...
                    ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="hidden" name="dropbox_progreso_link" value="" id="dropbox_progreso_link" />
                                <input type="hidden" name="dropbox_progreso_name" value="" id="dropbox_progreso_name" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="field-1" class="col-sm-4 control-label"><?php echo get_phrase('short_note'); ?></label>
    ...
    <?php include 'project_progreso_list.php'; ?>
    ...
    <script type="text/javascript">
        ...
        options_chooser = {
            ...
            success: function (files) {
                ...
                $("#dropbox_progreso_name").attr("value", files[0].name);
                $("#dropbox_progreso_link").attr("value", files[0].link);
            },
...
<script>
    ...
    var post_refresh_url = '<?php echo base_url(); ?>index.php?admin/reload_projectroom_progreso_list/<?php echo $project_code; ?>';
</script>
