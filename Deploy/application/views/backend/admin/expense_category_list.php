<div class="panel panel-primary" id="charts_env">
	<div class="panel-heading">
		<div class="panel-title">
			...
			<?php echo get_phrase('expense_category_list');?>
		</div>
	</div>
					...
					<td>
		            	<div class="btn-group">
		                    ...
		                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
		                        ...
		                        <!-- DELETION LINK -->
		                        <li>
		                            <a href="#" onclick="confirm_modal('<?php echo site_url('admin/accounting_expense_category/delete/' . $row['expense_category_id']);?>' , '<?php echo site_url('admin/reload_expense_category_list');?>');" >
